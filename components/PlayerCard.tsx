    ...
    >
      <defs>
        ...
        <pattern id="jersey" width="6" height="6" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <rect width="6" height="6" fill="#17181A" />
          <line x1="0" y1="0" x2="0" y2="6" stroke="#212224" strokeWidth="2" />
        </pattern>
      </defs>

      {/* fond */}
      <rect x="0" y="0" width="340" height="480" rx="18" fill="url(#jersey)" />
      <rect x="0.75" y="0.75" width="338.5" height="478.5" rx="17.5" fill="none" stroke="#2A2B2D" strokeWidth="1.5" />

      {/* marquage terrain : rond central discret en bas */}
      <circle cx="170" cy="500" r="150" fill="none" stroke="#EDE9E0" strokeOpacity="0.06" strokeWidth="2" />
      <line x1="20" y1="350" x2="320" y2="350" stroke="#EDE9E0" strokeOpacity="0.06" strokeWidth="2" />
      ...
      <text x="170" y="234" fill="#93938D" fontSize="13" textAnchor="middle" letterSpacing="0.5" fontFamily="Inter, sans-serif">
        {data.divisionLabel}
      </text>

      {/* stats */}
      <line x1="24" y1="262" x2="316" y2="262" stroke="#2A2B2D" strokeWidth="1" />
      {data.stats.slice(0, 4).map((s, i) => {
        ...
        return (
          <g key={s.label}>
            ...
            <text x={x} y={y + 20} fill="#93938D" fontSize="11" letterSpacing="1.5" fontFamily="Inter, sans-serif">
              {s.label.toUpperCase()}
            </text>
          </g>
        );
