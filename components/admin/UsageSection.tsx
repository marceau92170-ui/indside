...
export async function UsageSection() {
  ...
  return (
    <div>
      <h2 className="mb-1 font-condensed text-xl font-bold uppercase">Usage des pages</h2>
      ...
      {ranked.length === 0 ? (
        ...
        <>
          ...
          {clickRanked.length > 0 && (
            <div className="mt-10">
              <h3 className="mb-1 font-condensed text-lg font-bold uppercase">Boutons cliqués</h3>
              <p className="mb-4 text-xs text-muted">
          ...
          {exitRanked.length > 0 && (
            <div className="mt-10">
              <h3 className="mb-1 font-condensed text-lg font-bold uppercase">Où ils quittent</h3>
              <p className="mb-4 text-xs text-muted">
