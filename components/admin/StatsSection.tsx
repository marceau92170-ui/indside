...
// Vue d'ensemble business — 100% first-party (nos propres requêtes Postgres),
...
export async function StatsSection() {
  ...
  return (
    <div>
      <h2 className="mb-1 font-condensed text-xl font-bold uppercase">Vue d&apos;ensemble</h2>
      ...
      <h3 className="mb-2 font-condensed text-lg font-bold uppercase">Inscriptions (8 semaines)</h3>
      <div className="mb-6 rounded-card border border-line bg-surface p-4">
        <MonthlyActivity months={weeks} />
      </div>

      <h3 className="mb-2 font-condensed text-lg font-bold uppercase">Badges débloqués</h3>
